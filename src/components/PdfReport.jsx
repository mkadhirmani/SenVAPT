    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div id="vapt-pdf-report-root" className="space-y-8 flex flex-col items-center">
        ...
        <div className="pdf-page p-[10mm_12mm_10mm_12mm] bg-white text-slate-900 border border-slate-200">
          ...
          {/* Cover Body: High-density, professional executive presentation */}
          <div className="flex-1 flex flex-col justify-start space-y-3 pt-3 pb-1">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-[10.5px] text-slate-700 font-medium leading-snug break-words max-w-2xl">
                Comprehensive autonomous penetration testing audit deliverable covering attack surface reconnaissance, multi-stage exploit verification, threat chain analysis, and prioritized executive risk remediation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 p-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs font-mono">
              ...
              <div>
                ...
                <span className="font-bold text-rose-700 text-[10px]">{overallRiskLevel} ({overallRiskScore}/10 CVSS)</span>
              </div>
              <div>
              ...
              <div>
                ...
                <span className="font-bold text-slate-900 text-[10px]">Black-Box Autonomous Audit</span>
              </div>
              <div>
                <span className="text-slate-500 text-[8.5px] block font-bold uppercase">SECURITY AI TELEMETRY</span>
                <span className="font-bold text-cyan-800 text-[10px]">
              ...
              <div>
                ...
                <span className="font-bold text-emerald-700 text-[10px]">Audit Completed &amp; Signed</span>
              </div>
            </div>
            ...
            <div className="p-2.5 rounded-xl border border-slate-200 bg-white space-y-1 text-xs">
              <div className="font-bold text-slate-900 font-mono text-[9px] uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="p-2.5 rounded-xl border border-slate-200 bg-slate-50 space-y-1 text-xs">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 text-[9px] font-mono">
                <div className="p-1.5 rounded bg-white border border-slate-200">
                  <strong className="text-cyan-800 block text-[8.5px]">PHASE 1: RECON</strong>
                  <span className="text-slate-600">Perimeter mapping, endpoint discovery &amp; tech profiling.</span>
                </div>
                <div className="p-1.5 rounded bg-white border border-slate-200">
                  <strong className="text-cyan-800 block text-[8.5px]">PHASE 2: ATTACK</strong>
                  <span className="text-slate-600">Autonomous vulnerability discovery &amp; fuzzing.</span>
                </div>
                <div className="p-1.5 rounded bg-white border border-slate-200">
                  <strong className="text-cyan-800 block text-[8.5px]">PHASE 3: VERIFY</strong>
                  <span className="text-slate-600">Multi-stage exploit proof &amp; impact validation.</span>
                </div>
                <div className="p-1.5 rounded bg-white border border-slate-200">
                  <strong className="text-cyan-800 block text-[8.5px]">PHASE 4: REPORT</strong>
                  <span className="text-slate-600">Technical documentation &amp; prioritized remediation.</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-2.5 rounded-xl border border-slate-200 bg-white space-y-1 text-xs">
              ...
              <p className="text-slate-600 leading-relaxed text-[9.5px] break-words">
                Conducted in strict alignment with <strong>OWASP Web Security Testing Guide (WSTG v4.2)</strong>, <strong>OWASP API Security Top 10 (2023)</strong>, <strong>NIST SP 800-115</strong>, <strong>CWE/SANS Top 25</strong>, and <strong>CVSS v3.1 Scoring Standards</strong>. All observed vectors were verified to eliminate false positives.
              </p>
            </div>
          </div>
        ...
        <div className="pdf-page p-[10mm_12mm_10mm_12mm] bg-white text-slate-900 border border-slate-200">
          ...
          {/* Page Body: Fills page with executive analysis and roadmap */}
          <div className="flex-1 flex flex-col justify-start space-y-2.5 pt-2 pb-1">
            ...
            {customAiSummary ? (
              <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1.5 text-[10px] text-slate-800 leading-snug font-sans break-words">
                {renderFormattedMarkdown(customAiSummary)}
              </div>
            ) : (
              <>
                {/* Executive Assessment Overview */}
                <div className="space-y-1 text-[10px] text-slate-800 leading-snug font-sans break-words">
                  <p>
                ...
                {/* Top Risk Callout */}
                {topVuln && (
                  <div className="p-2.5 rounded-xl bg-amber-50 border-l-4 border-amber-500 text-slate-800 space-y-0.5 text-[10px]">
                    ...
                    <p className="leading-snug text-[9.5px] break-words">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {highVulns.length > 0 && (
                      <div className="p-2 rounded-lg border border-rose-200 bg-rose-50/50 space-y-1">
                        ...
                        <div className="text-[9px] text-slate-700 space-y-0.5 pl-1.5">
                          {highVulns.map(v => (
                ...
                <div className="space-y-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[9.5px]">
                    <div className="p-2 rounded-lg bg-rose-50 border border-rose-200 space-y-0.5">
                      ...
                      <p className="text-slate-700 text-[9px] leading-tight break-words">
        ...
        <div className="pdf-page p-[10mm_12mm_10mm_12mm] bg-white text-slate-900 border border-slate-200">
          ...
          {/* Page Body: High-density findings matrix and OWASP coverage grid */}
          <div className="flex-1 flex flex-col justify-start space-y-2.5 pt-2 pb-1">
            ...
            <div className="p-2.5 rounded-xl border border-slate-200 bg-white space-y-1.5 text-xs">
